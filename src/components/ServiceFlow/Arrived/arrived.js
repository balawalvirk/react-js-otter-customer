...
const ArrivedScreen = () => {
  ...
  return (
    <div className="service-flow-container arrived-screen">
      <ServiceHeader activeTab={activeTab} navigationItems={navigationItems} />

      <div className="service-flow-alert arrived-alert">
        <p>You’ve arrived at the job site. Begin diagnostics when ready.</p>
      </div>
      ...
      <section className="job-assigned-panel">
        ...
        <button type="button" className="start-diagnostics-btn">
          Start Diagnostics
        </button>
      </section>
