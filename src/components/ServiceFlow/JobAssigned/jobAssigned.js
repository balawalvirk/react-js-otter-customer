...
const JobAssigned = () => {
  ...
  return (
    <div className="service-flow-container">
      ...
      <div className="service-flow-alert">
        <p>New job assigned. Review details and start navigation when ready</p>
      </div>
      ...
      <section className="job-assigned-panel">
        ...
        <button type="button" className="start-navigation-btn">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <path
              d="M4.5 19.5L21 12L4.5 4.5L4.5 10.5L15 12L4.5 13.5L4.5 19.5Z"
              fill="white"
            />
          </svg>
          Start Navigation
