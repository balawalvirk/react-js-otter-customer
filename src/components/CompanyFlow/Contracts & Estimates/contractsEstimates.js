                ...
                <div key={contract.id} className="contract-item">
                  ...
                  <div className="contract-actions">
                    ...
                    <button className="action-btn download-btn" title="Download">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M8 11.3333V2.66667M8 2.66667L5.33333 5.33334M8 2.66667L10.6667 5.33334" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div className="signature-controls">
              <div className="signature-toggle">
                <label className="toggle-label">
                  <span>Enable In-App Signing</span>
